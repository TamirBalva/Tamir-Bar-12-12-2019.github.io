...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".forecast-box{\r\n    max-width: 120rem;\r\n    margin: 8rem auto;\r\n    box-shadow:var(--background-tertiary-shadow);\r\n    background-color: var(--background-secondary);\r\n    border-radius: 10px;\r\n    min-height: 50rem;\r\n    background-image: url(\"https://tamirbalva.github.io/tamir-bar-12-12-2019.github.io/assets/clouds-background.png\");\r\n    background-blend-mode: overlay;\r\n    justify-content: space-between;\r\n    align-items: center;\r\n\r\n}\r\n\r\n.header{\r\n    width: 100%;\r\n    margin-bottom: 2rem auto;    \r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
let CitySearchService = class CitySearchService {
    constructor(httpClient) {
        ...
        this.apikeys = [
            "aA5FYSF43JGLolniJ0VboOp3CNu0Me3J"
        ];
    }
    getCityKey(city) {
...
let Forecast = class Forecast {
    constructor(httpClient) {
        this.httpClient = httpClient;
        this.apikeys = [
            "5PrLdudCiYuWSNgEvgrUwQFdpnMs4PGw",
	    "k2F9MUTHJPymtYFFwOG1YU7kLDxuAwGo"
        ];
    }
    ...
    getCurrentForecast(cityKey) {
        return this.httpClient.get(`https://dataservice.accuweather.com/currentconditions/v1/${cityKey}?apikey=${this.apikeys[1]}`);
    }
